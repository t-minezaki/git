...
public interface F21072Dao {
     ...
     * @return
     */
    List<F21072Dto> selectManagerAndMentorById(@Param("messageId") Integer messageId, @Param("orgId") String orgId, @Param("pageSize") Integer pageSize
     ...
     * @return
     */
    Integer selectManagerAndMentorCount(@Param("messageId") Integer messageId, @Param("orgId") String orgId
