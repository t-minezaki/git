 ...
 * @version 1.0
 */
@RequestMapping("/common/F40013")
@RestController
public class F40013Controller {
    /**
     * F40013Service
     */
    @Autowired
    ...
    public R init(Integer limit, Integer page, String orgId, String orgNm) {
        ...
        if (limit != null) {
            offset = (page - 1) * limit;
            f40013DtoList = f40013Service.getF40013DtoList(userId, orgNm, orgId, limit, offset, manaFlag, brandCd, gid, tchCd, gidPk);
            count = f40013Service.getOrgCount(userId, orgNm, orgId, 0, null, manaFlag, brandCd, gid, tchCd, gidPk);
            return R.ok().put("page", new PageUtils(f40013DtoList, count, limit, page)).put("orgNow", orgNow).put("f40013DtoList", count);
        }
        f40013DtoList = f40013Service.getF40013DtoList(userId, orgNm, orgId, limit, offset, manaFlag, brandCd, gid, tchCd, gidPk);
