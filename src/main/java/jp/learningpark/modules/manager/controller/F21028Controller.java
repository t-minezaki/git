 ...
 */
@RestController
@RequestMapping("/manager/F21028")
public class F21028Controller {

    /**
     * f21028Service
     */
    @Autowired
    F21028Service f21028Service;
    ...
    public R getData(Boolean isFirst, Boolean pageTurning, String date, Integer grpId, String stuNm, String schyDiv, String stuIds,Boolean flag){
        ...
        return f21028Service.getLineDate(params);
    }
}
