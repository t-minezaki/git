...
import jp.learningpark.modules.manager.service.impl.F21029ServiceImpl;
 ...
 * @date 2020/02/17 11:54
 */
@RestController
@RequestMapping("/manager/F21029")
public class F21029Controller {

    /**
     * f21029Service
     */
    @Autowired
    F21029ServiceImpl f21029Service;
    ...
    public R getData(Boolean isFirst, Boolean pageTurning, String date, Integer grpId, String stuNm, String schyDiv, String stuIds){
        ...
        return f21029Service.getLineDate(params);
    }
}
