 ...
 * @version 1.0
 */
public interface F03003Service {
    /**
     ...
     * @return
     */
    List<F03003Dto> getTexdiff(Integer textbId, Integer crmLearnPrdId, Integer page, Integer limit);
     ...
     * @return
     */
    Integer getTexdiffCount(Integer textbId, Integer crmLearnPrdId);
}
