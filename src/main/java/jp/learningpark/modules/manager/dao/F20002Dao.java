...
public interface F20002Dao {
     ...
     * @return
     */
    List<F20002Dto> selectTextbDtoListOfSchByStuId(@Param("stuId") String stuId, @Param("orgId") String orgId);
     ...
     * @return 業務エラー判定リスト
     */
    List<F20002Dto> selectAboutWeekly(@Param("stuId") String stuId, @Param("textbIds") List<Integer> textbIds);
     ...
     */
    F20002Dto getStuInfoByStuId(@Param("stuId") String stuId, @Param("orgId") String orgId);
     ...
     * @return
     */
    List<F20002Dto> selectTexdeffExtend(@Param("orgId") String orgId, @Param("textbId") Integer textbId, @Param("crmschLearnPrdId") Integer crmschLearnPrdId);
}
