(function($) {
    ...
    $.fn.fSelect = function(options) {
        ...
        fSelect.prototype = {
            create: function() {
                ...
                this.$select.before('<div class="fs-label-wrap"><div class="fs-label">' + this.settings.placeholder + '</div><span class="fs-arrow-up"></span><span class="fs-arrow"></span></div>');
    ...
    $(document).on('click', '.fs-option', function() {
        ...
        $wrap.find('select').fSelect('onSelected');
