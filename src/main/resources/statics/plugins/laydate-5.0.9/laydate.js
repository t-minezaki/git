/*! laydate-v5.0.9 日付と時間のコンポーネント MIT License  http://www.layui.com/laydate/  By xianxin */
/*! 含めるnow，confirm */
;!function () {
    "use strict";
    var e = window.layui && layui.define, t = {
        ...
        }, i = "laydate", r = ".layui-laydate", o = "layui-this", s = "laydate-disabled", l = "開始日が終了日を超えました<br>再選択を提案します",
    ...
    C.prototype = [], C.prototype.constructor = C, w.extend = function () {
        ...
        var e = this, t = e.config, n = {
            cn: {
                ...
                tools: {clear: "クリア", confirm: "選択", now: "現在"}
            },
            en: {
        ...
        if (t.zIndex && (i.style.zIndex = t.zIndex), w.each(new Array(2), function (e) {
            ...
            return "datetime" === t.type && e.push('<span lay-type="datetime" class="laydate-btns-time">' + n.timeTips + "</span>"), w.each(t.btns, function (e, r) {
                var o = n.tools[r] || "btn";
                t.range && "now" === r || (a && "clear" === r && (o = "cn" === t.lang ? "リセット" : "Reset"), i.push('<span lay-type="' + r + '" class="laydate-btns-' + r + '">' + o + "</span>"))
        ...
        return "limit" === e ? (c(o), i) : (l = l || r.value, "string" == typeof l && (l = l.replace(/\s+/g, " ").replace(/^\s|\s$/g, "")), i.startState && !i.endState && (delete i.startState, i.endState = !0), "string" == typeof l && l ? i.EXP_IF.test(l) ? r.range ? (l = l.split(" " + r.range + " "), i.startDate = i.startDate || i.systemDate(), i.endDate = i.endDate || i.systemDate(), r.dateTime = w.extend({}, i.startDate), w.each([i.startDate, i.endDate], function (e, t) {
            m(t, l[e], e)
        })) : m(o, l) : (i.hint("日付の書式は不正です<br>下記の様式に従わなければならない：<br>" + (r.range ? r.format + " " + r.range + " " + r.format : r.format) + "<br>リセットしました"), a = !0) : l && l.constructor === Date ? r.dateTime = i.systemDate(l) : (r.dateTime = i.systemDate(), delete i.startState, delete i.endState, delete i.startDate, delete i.endDate, delete i.startTime, delete i.endTime), c(o), a && l && i.setValue(r.range ? i.endDate ? i.parse() : "" : i.parse()), e && e(), i)
        ...
        if (l.year < d[0] && (l.year = d[0], r.hint("一番早い年は" + d[0])), l.year > d[1] && (l.year = d[1], r.hint("遅くともの年は" + d[1])), r.firstDate || (r.firstDate = w.extend({}, l)), c.setFullYear(l.year, l.month, 1), t = c.getDay(), a = n.getEndDate(l.month || 12, l.year), i = n.getEndDate(l.month + 1, l.year), w.each(y, function (e, n) {
            ...
            year: l.year,
            month: l.month
        }, e && (r.listYM = [[r.startDate.year, r.startDate.month + 1], [r.endDate.year, r.endDate.month + 1]], r.list(s.type, 0).list(s.type, 1), "time" === s.type ? r.setBtnStatus("時間", w.extend({}, r.systemDate(), r.startTime), w.extend({}, r.systemDate(), r.endTime)) : r.setBtnStatus(!0))), s.range || (r.listYM = [[l.year, l.month + 1]], r.list(s.type, 0))), s.range && !e) {
        ...
        d && (t = t || i.startDate, n = n || i.endDate, a = i.newDate(t).getTime() > i.newDate(n).getTime(), i.limit(null, t) || i.limit(null, n) ? o.addClass(s) : o[a ? "addClass" : "removeClass"](s), e && a && i.hint("string" == typeof e ? l.replace(/日付/g, e) : l))
        ...
        var n = this, a = n.config, i = a.dateTime, r = "static" === a.position, o = {
            datetime: function () {
                ...
                if (a.range) {
                    if (!n.endDate) return n.hint("先に日付の範囲を選択してください");
                    if (w(e).hasClass(s)) return n.hint("time" === a.type ? l.replace(/日付/g, "時間") : l)
                } else if (w(e).hasClass(s)) return n.hint("有効な日付または時間の範囲内ではありません");
