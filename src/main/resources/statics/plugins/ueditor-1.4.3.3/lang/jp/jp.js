...
UE.I18N['en'] = {
    ...
    'insertimage':{
        'static':{
            ...
            'searchType':{'title':"画像のタイプ", 'options':["お知らせ", "壁紙", "表情", "写真"]},
        ...
        'errorLoadConfig': 'Server config not loaded, upload can not work.',
        'errorExceedSize':$.format($.msg.MSGCOMN0088,"お知らせ内容","画像","5M"),
    ...
    'attachment':{
        ...
        'errorNotSupport': 'WebUploader does not support the browser you are using. Please upgrade your browser or flash player',
        'errorLoadConfig': 'Server config not loaded, upload can not work.',
        'errorExceedSize':$.format($.msg.MSGCOMN0088,"お知らせ内容","添付ファイル","250M"),
    ...
    'insertvideo':{
        ...
        'errorNotSupport': 'WebUploader does not support the browser you are using. Please upgrade your browser or flash player',
        'errorLoadConfig': 'Server config not loaded, upload can not work.',
        'errorExceedSize':$.format($.msg.MSGCOMN0088,"お知らせ内容","動画ファイル","1GB"),
        'errorFileType':'File Type Not Allow',
        'errorInterrupt':'File Upload Interrupted',
        'errorUploadRetry':'Upload Error, Please Retry.',
        'errorHttp':'Http Error',
