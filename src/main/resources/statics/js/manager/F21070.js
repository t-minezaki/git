...
var vm = new Vue({
    ...
    methods: {
        ...
        init: function () {
            $.ajax({
                url: ctxPath + '/manager/F21070/init',
                type: 'GET',
                data: {
                    messageId: params.id
                },
                ...
                success: function (data) {
                    ...
                    if (data.adminIdList || params.usrId) {
                        vm.adminIdList = params.usrId ? JSON.parse(decodeURIComponent(params.usrId)) : data.adminIdList;
                        vm.selectLoad();
                    }
                }
            });
        ...
        selectLoad: function () {
            ...
            $("#jqGrid").jqGrid({
                    ...
                    // $("#jqgh_jqGrid_aid").text(vm.roleDiv === '1'?'管理者ID':'先生ID');
                    // $("#jqgh_jqGrid_aflnm").text(vm.roleDiv === '1'?'管理者名':'先生名');
                    }
                }
            );
        ...
        submit: function () {
            ...
            var index = layer.confirm($.format($.msg.MSGCOMN0021, "更新"), {
                ...
                btn2: function () {
                    $.ajax({
                        url: ctxPath + '/manager/F21070/save',
                        cache: false,
                        data: formData,
                        type: 'POST',
                        processData: false,
        ...
        getTemplate:function () {
            $.ajax({
                url: ctxPath + '/manager/F21070/getTemplate',
                async: true,
                datatype: "json",
                success: function (data) {
